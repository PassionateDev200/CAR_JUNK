/** route: src/components/quote/questions/OwnershipQuestion.jsx */
"use client";
...
export default function OwnershipQuestion({
  ...
  const options = [
    {
      value: "own_outright",
      label: "Yes, I own it outright (it's paid off)",
      priceAdjustment: null,
      description: "The vehicle is completely paid off and you have the title",
      isDisqualifying: false,
    },
    {
      value: "loan_payments",
      label: "No, I am still making loan payments",
      priceAdjustment: null,
      description: "You still owe money on a car loan for this vehicle",
      isDisqualifying: true,
    },
    {
      value: "lease_payments",
      label: "No, I make lease payments",
      priceAdjustment: null,
      description: "This vehicle is currently leased, not owned",
      isDisqualifying: true,
    },
  ];
  ...
  return (
    <QuestionLayout
      icon={User}
      title={`Do you own your ${getVehicleDisplayName()}?`}
      description="We can only purchase vehicles that are owned outright (fully paid off)."
    ...
    >
      <Box sx={{ maxWidth: "700px", mx: "auto" }}>
        {showWarning && (
          ...
          >
            We can only purchase vehicles that are owned outright. We'll redirect
            you shortly.
          </Alert>
        )}
