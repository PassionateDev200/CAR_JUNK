...
export async function POST(request) {
  try {
    ...
    // ❌ REMOVED: Admin notification on quote submission
    // Admin will only receive notification when seller schedules pickup
    // This minimizes emails and only sends when seller completes the full flow
    console.log(`✅ Quote ${quoteId} submitted. Admin will be notified when pickup is scheduled.`);
