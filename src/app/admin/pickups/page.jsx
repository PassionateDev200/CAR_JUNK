      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage vehicle pickup schedules and routes
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Per pickup</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardContent className="p-8 text-center">
          ...
          <p className="text-sm text-gray-500">
            Calendar integration, route optimization, and driver assignments.
          </p>
        </CardContent>
      </Card>
    </div>
